...
describe('ClaudianPlugin', () => {
  ...
  describe('onload', () => {
    ...
    it('should register discoverable MuseAI command names', async () => {
      ...
      expect(getRegisteredCommand('check-ai-flavor').name).toBe('MuseAI: Check current chapter AI flavor');
      expect(getRegisteredCommand('rewrite-selection-ai-flavor').name).toBe('MuseAI: Rewrite selected text to reduce AI flavor');
