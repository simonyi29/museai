  ...
  render(container, context) {
    ...
    if (isWindowsHost) {
      new Setting(container)
        ...
        .setDesc('How MuseAI should launch Codex on Windows. Native Windows uses a Windows executable path. WSL launches the Linux CLI inside a selected distro.')
    ...
    mcpDesc.appendText(' and they will be available in MuseAI. ');
    mcpDesc.createEl('a', {
      text: 'Learn more',
